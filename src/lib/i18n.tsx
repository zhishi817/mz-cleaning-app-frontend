...
const dictionary = {
  zh: {
    ...
    profile_edit: '编辑资料',
    profile_name: '昵称',
    profile_legal_name: '个人姓名',
    profile_phone: '手机号',
    profile_bank_account_name: '银行账户名',
    profile_bank_bsb: 'BSB',
    profile_bank_account_number: '银行账号',
    profile_personal_abn: '个人 ABN',
    profile_photo_id: 'Photo ID',
    profile_photo_id_upload: '上传 Photo ID',
    profile_photo_id_hint: '上传后会添加整版水印：仅用于 MZ Property（ABN：42 657 925 365）记录，不做任何其他用途。',
    profile_photo_id_missing: '请先上传 Photo ID',
    profile_visa_information: '签证信息',
    profile_visa_grant_number: 'Visa Grant Number',
    profile_visa_grant_number_placeholder: '请输入 Visa Grant Number',
    profile_visa_hint: '请上传您的签证文件。仅用于公司记录存档，不做任何其他用途。文件将添加整版水印。',
    profile_visa_upload: '上传签证文件',
    profile_visa_missing: '请先上传签证文件',
    profile_dept: '部门',
    profile_title: '职位',
    profile_save: '保存',
    profile_avatar: '头像',
  ...
  en: {
    ...
    profile_phone: 'Phone',
    profile_bank_account_name: 'Account Name',
    profile_bank_bsb: 'BSB',
    profile_bank_account_number: 'Account Number',
    profile_personal_abn: 'Personal ABN',
    profile_photo_id: 'Photo ID',
    profile_photo_id_upload: 'Upload Photo ID',
    profile_photo_id_hint: 'A full-page watermark will be added: For the records of MZ Property (ABN: 42 657 925 365) only, not for other purpose.',
    profile_photo_id_missing: 'Please upload a photo ID first',
    profile_visa_information: 'Visa Information',
    profile_visa_grant_number: 'Visa Grant Number',
    profile_visa_grant_number_placeholder: 'Enter Visa Grant Number',
    profile_visa_hint: 'Please upload your visa information. For company records only, not for any other purpose. A full-page watermark will be added.',
    profile_visa_upload: 'Upload Visa Document',
    profile_visa_missing: 'Please upload your visa document first',
    ...
    profile_invalid_abn: 'Invalid ABN format',
    ...
    tasks_btn_repair: 'Feedback',
    tasks_btn_complete: 'Complete',
    repair_title: 'Feedback',
