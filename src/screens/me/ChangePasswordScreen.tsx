...
const styles = StyleSheet.create({
  ...
  inputWrap: { flexDirection: 'row', alignItems: 'center', minHeight: 44, borderRadius: 12, borderWidth: hairline(), borderColor: '#D1D5DB', paddingHorizontal: 12, backgroundColor: '#FFFFFF' },
  input: { flex: 1, minWidth: 0, minHeight: 44, color: '#111827', fontSize: moderateScale(14), fontWeight: '700' },
  eyeBtn: { width: 34, height: 34, borderRadius: 10, alignItems: 'center', justifyContent: 'center' },
  btn: { marginTop: 16, minHeight: 46, paddingHorizontal: 12, paddingVertical: 11, borderRadius: 14, backgroundColor: '#2563EB', alignItems: 'center', justifyContent: 'center' },
  btnDisabled: { backgroundColor: '#93C5FD' },
  btnText: { color: '#FFFFFF', fontWeight: '900', fontSize: 15, textAlign: 'center' },
